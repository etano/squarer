...
!version of potgen for short ranged potenials only. No k-space part 5.24.07
     ...
     &,rlread,potx,expon(20),cexpon(20)
      character fname*30,p(mn)*28,eunit*3,lunit*3
...
!       data eps,rm/10.948,2.963/
!       data a,alpha,beta,d,c6,c8,c10/184431.01,10.43329537,-2.27965105
!    +  ,1.4826,1.36745214,.42123807,.17473318/
c helium-helium (aziz-2) potential JCP 70,4330 (1979)
     ...
     +,1.3732412d0,.4253785d0,.178100d0/
      data rm,beta/2.9673d0,0.d0/
       cite= 'Aziz et al., J. Chem.Phys. 70, 4330(1979)'
...
c distance in abohr
     ...
     &           - f*r6i*(c6 + r2i*(c8 + r2i*c10 - c9*ri)) )
      ...
      pott=(1.d0-exp(-.001d0*p3*rv**p4))
     &        *(2*d**2/rv**3+p1/rv**5+p2/rv**6)
      else
