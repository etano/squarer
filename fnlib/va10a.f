      subroutine va10a (funct, n, x, f, g, h, w, dfn, xm,
...
c w is an array of 4*n elements
      ...
      real*8 x,f,g,h,w,dfn,xm,hh,eps,zero,half,one,two,z,zz,dmin,df
      real*8 gs0,aeps,alpha,ff,tot,f1,f2,gys,dgs,sig
      integer n,mode,maxfn,iprint,iexit,np,n1,nn,is,iu,iv,ib,idiff,ij
      integer i,j,i1,jk,ik,k,itn,ifn,link,int

      data zero, half, one, two /0.0, 0.5, 1.0, 2.0/
      save  zero, half, one, two
      dimension x(2), g(2), h(2), w(2), xm(2)
      external funct
c     if (iprint .ne. 0) write (6,1000)
