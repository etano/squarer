...
C
C  Change record:
C     89-05-31   Changed all specific intrinsics to generic.  (WRB)
C
C ----------------------------------------------------------------------
C
      real*8 rcond,anorm,ek,s,wk,wkm,sm,t,a,z,sasum,sdot,ynorm
      integer lda,n,ipvt,j,info,k,kp1,kb,l
      dimension A(LDA,1),Z(1),IPVT(1)
C
C
