...
c     write (9,969) (diff(i),i=1,nx)
      ...
      parameter (mnkv=2000,mnsh=2000,mdim=3)
      integer kmult(0:mnsh)
      real*8 tpiell(mdim),rkcomp(mdim,mnkv),rknorm(mnsh),b(40)
     .   ,bb(6),work(5550)
     +  ,vkbare(mnsh),wtk(mnsh),ell(0:mdim),cent,g
...
c interprets potential parameter and sets up table.
      ...
      save c6,c8,c9,c10,alpha,beta,gamma,abohr,hartok,rm,d
     .,beta1,g,evtok
      data icall/0/
      data cite/' '/
      icall=icall+1
